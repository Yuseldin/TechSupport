...
<p>    
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" OnDataBinding="DropDownListSelectMember_SelectedIndexChanged" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Label ID="lblAddName" runat="server" Text="Name"></asp:Label>
            &nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="txtBoxAddName" runat="server" Visible="False" Width="130px"></asp:TextBox>
            <br />
            <asp:Label ID="lblAddPhone" runat="server" Text="Phone"></asp:Label>
            &nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="txtBoxAddPhone" runat="server" Visible="False" Width="130px"></asp:TextBox>
        </ContentTemplate>
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="DropDownListSelectMember" EventName="SelectedIndexChanged" />
        </Triggers>
    </asp:UpdatePanel>
    <p>    
        &nbsp;</p>
